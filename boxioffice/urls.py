...
urlpatterns = [
    ...
    url(r'^json/booking/(?P<pk>\d+)/$', booking_views.ShowDetailsJSON, name='json_show_details'),
    #ShowDetailsJSON
    ...
    url(r'^booking/theater/seats/(?P<pk>\d+)/$', booking_views.TheaterSeatsJSON, name='theater-seats'),
